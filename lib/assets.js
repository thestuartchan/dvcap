...
export const ASSETS = [
  {
    ...
    id:"gold", name:"Physical Gold", icon:"🥇", color:P.amber700, bg:C.aBg, bdr:P.amber200,
  ...
  {
    id:"tbonds", name:"Treasury Bonds", icon:"🏛️", color:C.blue, bg:C.blBg, bdr:C.blBdr,
  ...
  {
    id:"staples", name:"Consumer Staples", icon:"🛒", color:P.violet800, bg:P.violet50, bdr:P.violet300,
  ...
  {
    id:"btc", name:"Bitcoin", icon:"₿", color:P.bitcoin, bg:P.bitcoinBg, bdr:P.bitcoin,
