...
export async function assembleRegion(region) {
  ...
  const [quotes, idxRaw, macro, korea, cross, nqLow, volTermRaw, soxRes, smicAH] = await Promise.all([
  ...
  return { R, quotes, idxRaw, macro, korea, regime, cross, hyg, leaning, csop7709, volTerm, handoff, scenarios, nqLow, read, marketRegime, ladder, fx, won, intervention };
}
