...
export async function assembleRegion(region) {
  ...
  const scenarios = evaluateScenarios({
    ...
    tenThirtyDeltaBps: (macro.us30y?.deltaBps != null && macro.us10y?.deltaBps != null)
      ...
      : null,
    tlt: crossRow('TLT') ? { value: crossRow('TLT').changePct, atr: crossRow('TLT').atrPct ?? null, date: quoteDate(crossRow('TLT')) } : null,
    ...
    units7709: csop7709?.available ? { value: csop7709.dayPct, atr: csop7709.atr ?? null, date: csop7709.date ?? null } : null,
