...
export async function assembleRegion(region) {
  ...
  return { R, quotes, idxRaw, macro, korea, regime, cross, hyg, leaning, csop7709, volTerm, handoff, scenarios, smhSoxx, fxPnl, nqLow, read, marketRegime, ladder, fx, won, intervention };
}
