...
import { getQuotes, getMacro, getKoreaStress, getCrossAssets, hygCreditTell, fxDivergence } from './quotes.js';
...
export async function assembleRegion(region) {
  ...
  const leaning = gaugesLeaning({
    ...
    units7709Series: KOFIA_STORE.series?.units7709 || [],   // P2 — for the two-consecutive-down-days test
  });
  ...
  return { R, quotes, idxRaw, macro, korea, regime, cross, hyg, leaning, nqLow, read, marketRegime, ladder, fx, won, intervention };
}
