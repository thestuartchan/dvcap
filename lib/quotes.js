...
// A local credit/fear channel distinct from the global OAS read. Tells:
...
//   etf    — CSOP 7709 (2x Hynix) price + units (dashboard only; retired from Pre-Read)
// VKOSPI: we read the FUTURES (VKI1!) — the tradeable contract — not the spot index
// (CNBC .KSVKOSPI), which sits in heavy backwardation to the future during a vol spike.
// No keyless feed lists the future except TradingView's widget endpoint (best-effort;
// see tradingview.js). etf/units remain for the dashboard's KoreaStressPanel.
