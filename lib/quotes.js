...
export async function getMacro() {
  const [wti, brent, dgs2, dgs10, dgs30, oas, dxyC, goldC, btcC, dfii10, t10yie, fwd5y5y, moveC, ovxC, oasHist] = await Promise.all([
    ...
    fredSeries('BAMLH0A0HYM2', 90),  // 90 obs — enough for a 60d trend window   // real prior prints — backs the OAS 2-D gate's direction
  ]);
  ...
  return {
    ...
    gold, btc, realYield, breakeven, fwdBreakeven, move, ovx, regimeSignal,
  };
}
