...
import { yahooChart, yahooPrePost, yahooTrend, yahooIntradayLast } from './yahoo.js';
...
export async function getMacro() {
  const [wti, brent, dgs2, dgs10, dgs30, oas, dxyC, goldC, btcC, dfii10, t10yie, fwd5y5y, termPrem, moveC, ovxC, oasHist, dgs30Hist, dgs5] = await Promise.all([
    ...
    fredSeries('BAMLH0A0HYM2', 90),  // 90 obs — enough for a 60d trend window
    fredSeries('DGS30', 40),         // Section E — 30Y history for the 20d change
