...
export function buildWalletCard(events = [], holdings = [], {
  ...
  return {
    embeds: [{
      ...
      // literally there. So the title gets one, matching the pre-reads' house style, and the
      // wallet's own custom mark stays on the first description line where it can be drawn.
