...
const t = (symbol, address, decimals, hl, label) => ({ symbol, address, decimals, hl: hl ?? null, label: label ?? null });
...
export const CHAINS = Object.freeze({
  ...
  ethereum: {
    ...
    tokens: [
      ...
      t('USDT', '0xdAC17F958D2ee523a2206206994597C13D831ec7', 6, 'USDT'),
      t('DAI',  '0x6B175474E89094C44Da98b954EedeAC495271d0F', 18, 'DAI'),
  ...
  arbitrum: {
    ...
    tokens: [
      ...
      t('USDT0', '0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9', 6, 'USDT', 'USD₮0'),
      ...
      t('DAI',   '0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1', 18, 'DAI'),
    ],
  },
  base: {
    ...
    tokens: [
      ...
      t('DAI',   '0x50c5725949A6F0c72E6C4a641F24049A917DB0Cb', 18, 'DAI'),
  ...
  polygon: {
    ...
    tokens: [
      ...
      t('USDT0',  '0xc2132D05D31c914a87C6611C10748AEb04B58e8F', 6, 'USDT'),
      t('DAI',    '0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063', 18, 'DAI'),
