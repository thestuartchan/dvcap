...
export function regimeLogRow(snap, { date = snap.nowIso, extra = {}, source = 'cron' } = {}) {
  ...
  return {
    ...
    // What the two measured axes said the same day — verdicts and leans, from lib/quadrant.js —
    // so the watching period is a comparison inside one row, not across two files.
