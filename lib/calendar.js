...
export function weekHighlights(ref = new Date(), region = null, tz = null) {
  ...
  // for that region shows) through the next 7 days. When a region is passed, keep only
  // what's relevant to it — events tagged for that region PLUS anything scope:"global"
