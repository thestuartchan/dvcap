...
//
// The pre-open run reads open interest that OCC settled overnight — that is the whole reason it
// runs pre-open, and it is the reading worth keeping. The evening run reads the same day late,
